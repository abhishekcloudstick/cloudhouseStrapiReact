...
export interface ApiConstructionAdvancedReportingConstructionAdvancedReporting
  extends Struct.CollectionTypeSchema {
  collectionName: 'construction_advanced_reportings';
  info: {
    displayName: 'constructionAdvancedReporting';
    pluralName: 'construction-advanced-reportings';
    singularName: 'construction-advanced-reporting';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    advancedItem: Schema.Attribute.Component<'custom.advanced-reporting', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::construction-advanced-reporting.construction-advanced-reporting'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiConstructionProjectManagementConstructionProjectManagement
  extends Struct.CollectionTypeSchema {
  collectionName: 'construction_project_managements';
  info: {
    displayName: 'ConstructionProjectManagement';
    pluralName: 'construction-project-managements';
    singularName: 'construction-project-management';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiDevopsPlanDevopsPlan extends Struct.CollectionTypeSchema {
  collectionName: 'devops_plans';
  info: {
    displayName: 'DevopsPlan';
    pluralName: 'devops-plans';
    singularName: 'devops-plan';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    devopfeatures: Schema.Attribute.Component<'custom.devopsfeatures', true>;
    icon: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::devops-plan.devops-plan'
    > &
      Schema.Attribute.Private;
...
export interface ApiDevopsSolutionDevopsSolution
  extends Struct.CollectionTypeSchema {
  collectionName: 'devops_solutions';
  info: {
    displayName: 'DevopsSolution';
    pluralName: 'devops-solutions';
    singularName: 'devops-solution';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::devops-solution.devops-solution'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiErpModuleErpModule extends Struct.CollectionTypeSchema {
  collectionName: 'erp_modules';
  info: {
    displayName: 'ERPModule';
    pluralName: 'erp-modules';
    singularName: 'erp-module';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    erpfeature: Schema.Attribute.Component<'custom.erpfeatures', true>;
    icon: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    link: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::erp-module.erp-module'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiFAndQFAndQ extends Struct.CollectionTypeSchema {
  collectionName: 'f_and_qs';
  info: {
    displayName: 'Q and A';
    pluralName: 'f-and-qs';
    singularName: 'f-and-q';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHiringHiring extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    postDate: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    feature: Schema.Attribute.Component<'custom.features', true>;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AdvancedTechnologies: Schema.Attribute.Text;
    categories: Schema.Attribute.UID<'title'>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    EfficientTimeline: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    MeasurableResults: Schema.Attribute.Text;
    ourSolution: Schema.Attribute.Text;
    ProjectHighlightIcon: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
    tags: Schema.Attribute.Component<'custom.tags', true>;
    tech: Schema.Attribute.Component<'custom.tech-used', true>;
    theResult: Schema.Attribute.Text;
...
export interface ApiServerCareServerCare extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'ServerCare';
    pluralName: 'server-cares';
    singularName: 'server-care';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSoftwareProjectManagementSoftwareProjectManagement
  extends Struct.CollectionTypeSchema {
  collectionName: 'software_project_managements';
  info: {
    displayName: 'softwareProjectManagement';
    pluralName: 'software-project-managements';
    singularName: 'software-project-management';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    capabilities: Schema.Attribute.Component<'custom.capabilities', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::software-project-management.software-project-management'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiSupportCoverageSupportCoverage
  extends Struct.CollectionTypeSchema {
  collectionName: 'support_coverages';
  info: {
    displayName: 'supportCoverage';
    pluralName: 'support-coverages';
    singularName: 'support-coverage';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSupportedControlPanelSupportedControlPanel
  extends Struct.CollectionTypeSchema {
  collectionName: 'supported_control_panels';
  info: {
    displayName: 'SupportedControlPanel';
    pluralName: 'supported-control-panels';
    singularName: 'supported-control-panel';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::supported-control-panel.supported-control-panel'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTypesofMalwareTypesofMalware
  extends Struct.CollectionTypeSchema {
  collectionName: 'typesof_malwares';
  info: {
    displayName: 'TypesofMalware';
    pluralName: 'typesof-malwares';
    singularName: 'typesof-malware';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::typesof-malware.typesof-malware'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
